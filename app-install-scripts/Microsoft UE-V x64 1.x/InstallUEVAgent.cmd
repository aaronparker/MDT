...
START /WAIT MSIEXEC /I AgentSetupx64.MSI %OPTIONS% ALLUSERS=TRUE REBOOT=SUPPRESS /QB- /l* %LOGDIR%\UEV-Agent.log
REM	MSIEXEC /I ToolsSetupx64.MSI ALLUSERS=TRUE REBOOT=SUPPRESS /QB- /l* %LOGDIR%\UEV-Tools.log
